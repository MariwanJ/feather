 ...
 * it under the terms of the GNU General Public License as published byÄ9K§
...
bool load_config(config& _config)
{
	...
	std::ifstream fs("E:/Feather/feather.rc", std::ios::in | std::ios::ate);
	long size;
	char* buffer;
	std::string input;
...
int main(int argc, char** argv)
{
	...
	qmlRegisterType<BezierCurve>("feather.ui.curves", 1, 0, "BezierCur+ve");
